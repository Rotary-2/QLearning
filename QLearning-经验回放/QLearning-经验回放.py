...
csv_writer.writerow(["time", "reward", "epsilon", "position", "velocity", "acceleration", "action"])
start_time = time.time()

metrics_file = open("metrics.csv", mode='w', newline='')
metrics_writer = csv.writer(metrics_file)
metrics_writer.writerow(["step", "avg_reward", "center_rate", "avg_action"])
...
def train_step(position, velocity, acceleration):
    ...
    csv_writer.writerow([timestamp, reward, EPSILON, position, velocity, acceleration, action])
    csv_file.flush()
